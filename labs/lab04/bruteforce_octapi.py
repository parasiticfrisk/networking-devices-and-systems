...
# Assign: Lab 04
# File: bruteforce_octapi.py
#
# Description: Make and break Enigma-encoded messages using the Raspberry Pi
#              and OctaPi (see lab 03).
#
...
cluster = dispy.JobCluster(
    find_rotor_start, ip_addr=s.getsockname()[0], nodes="192.168.1.*"
)
...
for job in jobs:
    ...
    if start_pos != "Cannot find settings":
        found = True
        print(
            "Rotors %s, ring %s, message key was %s, using crib %s"
