...
# Assign: Lab 03
# File: semi_prime_standalone.py
#
# Description: Generates the product of two random primes on the Octapi client
#              machine so that these values can be determined using
#              factorisation. This is intended to show how much longer it takes
#              to factor a 'semi-prime' number than to generate it.
#
